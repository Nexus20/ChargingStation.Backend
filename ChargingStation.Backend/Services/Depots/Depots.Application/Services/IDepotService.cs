...
{
    Task<IPagedCollection<DepotResponse>> GetAsync(GetDepotsRequest request, Guid userId, bool checkAccess,
        CancellationToken cancellationToken = default);
    Task<DepotResponse> GetByIdAsync(Guid id, Guid userId, bool checkAccess,
        CancellationToken cancellationToken = default);
