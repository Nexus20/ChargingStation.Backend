...
namespace ChargingStation.Infrastructure.Migrations
{
    ...
    [Migration("20240609134407_UniqueConnectorChargingProfile")]
    partial class UniqueConnectorChargingProfile
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChargingStation.Domain.Entities.OcppTag", b =>
                {
                    b.HasOne("ChargingStation.Domain.Entities.ApplicationUser", "ApplicationUser")
                        .WithOne()
                        .HasForeignKey("ChargingStation.Domain.Entities.OcppTag", "ApplicationUserId")
